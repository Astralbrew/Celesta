...
namespace Astralbrew.Celesta.Compiler
{
    public partial class Parser
    {
        ...
        public Parser()
        {
            ...
            //AddPatternRule("@FOR", "for SYMBOL from @E to @E step @E do @SCOPE endfor|end", "~forrange %1 %2 %3 %4 %5");
            //AddPatternRule("@FOR", "for SYMBOL from @E to @E do @SCOPE endfor|end", "~forrange %1 %2 %3 %4");
            //AddPatternRule("@FOR", "for ( @E ; @E ; @E ) @SCOPE endfor|end", "~cfor %1 %2 %3 %4");
            ...
            AddPatternRule("@DECL", "var SYMBOL : SYMBOL = @E", "~decl %2 %1 %3");
            AddPatternRule("@DECL", "var SYMBOL : SYMBOL", "~decl %2 %1");
