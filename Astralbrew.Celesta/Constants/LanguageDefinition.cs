...
namespace Astralbrew.Celesta.Constants
{
    public static class LanguageDefinition
    {
        ...
        {
            "if", "then", "else", "endif", "while", "do", "endwhile", "for", "from", "step", "endfor", "end",
            "repeat", "endrepeat",
            "var",
            "true", "false"
        };
        ...
        public static class PrimitiveTypes
        {
            ...
            public static DataTypeDefinition Integer => new DataTypeDefinition("int", (int)0, "0");
            public static DataTypeDefinition Decimal => new DataTypeDefinition("decimal", (double)0, "0");
            public static DataTypeDefinition String => new DataTypeDefinition("string", "", "\"\"");
            public static DataTypeDefinition Boolean => new DataTypeDefinition("bool", false, "false");
            public static DataTypeDefinition Void => new DataTypeDefinition("void", new NoOutput());
            public static DataTypeDefinition Any => new DataTypeDefinition("any");
