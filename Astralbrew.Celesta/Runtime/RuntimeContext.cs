...
namespace Astralbrew.Celesta.Runtime
{
    ...
    {
        public DefinitionContext DefinitionContext { get; } = new DefinitionContext();

        Dictionary<VariableDefinition, object> Variables = new Dictionary<VariableDefinition, object>();
        
        protected object GetValueOf(VariableDefinition variable)
        {
        ...
        protected object GetValueOf(object obj, DataTypeDefinition dataType)
        {
        ...
        public virtual object Evaluate(ISyntaxTreeNode syntaxTreeNode)
        {
            ...
            {                
                ...
                var variable = (assignment.LeftHandSide as VariableNode).Variable;
        ...
        public static RuntimeContext DefaultRuntimeContext
        {
            get
            {
                ...
                context.RegisterOperator("and", Bool, Bool, Bool, (a, b) => (bool)a && (bool)b);
